    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-4 sm:p-6 mb-6">
      ...
      <div className="md:hidden divide-y divide-slate-100">
        {GRAMMASI_LIST.map((gramasi) => {
          ...
          return (
            <div key={gramasi} className="p-3.5 space-y-2.5">
              {/* Card Header: Gramasi & Completeness */}
              ...
              {photo ? (
                <div className="flex items-center gap-3 bg-slate-50 p-2 rounded-xl border border-slate-200">
                  <button
                    ...
                    className="group relative w-12 h-12 rounded-lg overflow-hidden border border-slate-200 bg-slate-100 shrink-0 shadow-2xs"
                  ...
                  <div className="min-w-0 flex-1 text-xs">
                    <button
                      ...
                      className="font-semibold text-slate-800 hover:text-amber-700 truncate block text-left transition-colors"
                    >
                    ...
                    <div className="flex items-center gap-3 mt-1.5">
                      <button
                        ...
                        className="text-amber-600 font-semibold text-[11px] inline-flex items-center gap-0.5"
                      >
                        <Eye className="w-3 h-3" /> Preview
                      </button>
                      <a
                        href={`/api/files/${photo.id}/download`}
                        className="text-slate-600 font-medium text-[11px] inline-flex items-center gap-0.5"
                      >
                      ...
                      {isEditable && (
                        <button
                          ...
                          disabled={isPending}
                          className="text-red-500 font-medium text-[11px] inline-flex items-center gap-0.5 cursor-pointer"
                        >
                ...
                <div className="flex items-center justify-between bg-amber-50/70 border border-amber-200/80 p-2.5 rounded-xl">
                  ...
                  {isEditable && (
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-amber-500 hover:bg-amber-600 text-slate-900 font-semibold text-xs transition-colors cursor-pointer shadow-2xs"
                    >
